...
const options = {
	debug_mode: {
		...
		help: __(
			'All debug functions like *zu_log()* will be activated. Otherwise all calls will be muted.',
			'zu-plus',
		),
	},
	dup_page: {
	...
	cookie_notice: {
		...
		help: __(
			'Allows you to inform users that the site uses cookies and to comply with the EU GDPR regulations.',
			'zu-plus',
		),
	...
	disable_cached: {
		...
		help: __(
			'Disabling caching will result in memory savings, but relatively small (**not recommended**).',
			'zu-plus',
		),
	},
	disable_admenu: {
...
const debug = {
	use_kint: {
		...
		help: __(
			'[Kint for PHP](https://kint-php.github.io/kint/) is a tool designed to present debugging data in the best way possible graphically.',
			'zu-plus',
		),
	},
	// debug_rsjs: {
	...
	classname_only: {
		...
		help: __(
			'Only *class names* will be logged instead of a detailed data of the class instance (its props and methods).',
			'zu-plus',
		),
	},
	avoid_ajax: {
		...
		help: __(
			'All logging inside AJAX calls (via **admin-ajax.php**) will be ignored.',
			'zu-plus',
		),
	},
	...
	debug_bar: {
		...
		help: __(
			'Works only if [Query Monitor](https://github.com/johnbillion/query-monitor) is activated.',
			'zu-plus',
		),
		divider: 2,
	},
	debug_frontend: {
		...
		help: __(
			'Enable debugging JS & CSS on the front side. Used only with Debug Bar.',
			'zu-plus',
		),
		depends: 'debug_bar',
	},
	...
	instant_caching: {
		...
		help: __(
			'All logs will be stored in the memory of **the current page** and will not be available after the refresh.',
			'zu-plus',
		),
	},
	write_file: {
	...
	flywheel_log: {
		...
		help: __(
			'[Local by Flywheel](https://localwp.com//) is a free development application to develop WordPress locally.',
			'zu-plus',
		),
		depends: 'write_file',
	},
	overwrite: {
		...
		help: __(
			'The log data will be **overwritten on every reload**, otherwise it will be appended to the file/Debug Bar.',
			'zu-plus',
		),
	...
	debug_menus: {
		...
		help: __(
			'The current order of items in **menus** and **submenus** will be logged.',
			'zu-plus',
		),
		divider: 2,
	},
...
const dumpMethod = {
	...
	help: __(
		'Choose which method will be used to output **human-readable** information about a logged data.\nAttention! `var_export` does not handle circular references (**try another option in case of error**).',
		'zu-plus',
	),
	options: [
...
const duplicate = {
	...
	help: __(
		'Here you can easily duplicate any of your **WordPress Menus**. Just follow the instructions.',
		'zu-plus',
	),
