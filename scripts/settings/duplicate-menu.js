...
import { Button, MenuItem, NavigableMenu, Popover } from '@wordpress/components'
...
const ZuplusDupMenu = ({ labels, menus, ajaxAction }) => {
				...
				>
					<div className={cprefix}>
						<div className="__title">
							...
							<Button className="__close" icon={closeIcon} onClick={closeLinkUI} />
						</div>
